...
<main class="min-h-screen">
    ...
    <section class="relative overflow-hidden pb-16 pt-20">
        <!-- Ambient glows -->
        <div aria-hidden="true" class="pointer-events-none absolute -top-32 right-1/4 h-96 w-96 rounded-full bg-primary/10 blur-3xl"></div>
        <div aria-hidden="true" class="pointer-events-none absolute -left-24 top-40 h-80 w-80 rounded-full bg-cyan-glow/10 blur-3xl"></div>

        <div class="relative mx-auto max-w-3xl px-4 text-center">
            <h1 class="text-balance text-3xl font-extrabold leading-tight text-ink md:text-5xl">
                <span class="text-gold">دانلود رمان</span> با رمانینو؛ بهترین سایت خرید رمان
            </h1>
            <p class="mt-4 text-pretty leading-relaxed text-ink-muted md:text-lg">
            ...
            <form role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="glass mx-auto mt-8 flex max-w-xl items-center gap-2 rounded-2xl p-2 glow-gold focus-within:border-primary/50 transition-all duration-300">
                <input type="hidden" name="post_type" value="product" />
                <input type="search" name="s" placeholder="اسم رمان، نویسنده یا ژانر رو جستجو کن..." class="min-w-0 flex-1 bg-transparent px-3 py-2 text-sm text-ink placeholder:text-ink-muted focus:outline-none" aria-label="جستجوی رمان" required />
                <button type="submit" class="flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-sm font-bold text-[#0f0726] transition-transform duration-100 hover:scale-105 hover:shadow-[0_0_15px_rgba(234,179,8,0.6)]">
        ...
        <div class="relative mx-auto mt-6 max-w-3xl px-4">
            ...
            <div class="flex items-center justify-center gap-2 overflow-x-auto">
                <?php foreach ( $romanino_hashtags as $romanino_ht ) : ?>
                    <a href="<?php echo esc_url( $romanino_ht['link'] ); ?>" class="glass inline-flex shrink-0 items-center gap-1 whitespace-nowrap rounded-full px-4 py-1.5 text-xs font-bold text-cyan-glow transition-all duration-150 hover:glow-cyan hover:text-ink">
                        <span class="text-gold" aria-hidden="true">#</span><?php echo esc_html( $romanino_ht['label'] ); ?>
                    </a>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <section class="mx-auto max-w-6xl px-4 py-14">
        <div class="mb-8 flex items-center justify-center gap-3">
            <svg class="h-6 w-6 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"></path></svg>
            <h2 class="text-balance text-center text-2xl font-bold text-ink md:text-3xl">دسته‌بندی‌های دانلود رمان در رمانینو</h2>
        </div>
            ...
            ?>
                <li>
                    <a href="<?php echo esc_url( get_term_link( $category ) ); ?>" class="glass flex flex-col items-center gap-2.5 rounded-2xl p-5 text-center transition-all duration-200 hover:glow-gold hover:-translate-y-1">
                        ...
                        <div class="h-12 w-12 overflow-hidden rounded-full bg-primary/10">
                        ...
                        <?php else : ?>
                        <div class="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 text-gold group-hover:bg-primary/20">
                        ...
                        <?php endif; ?>
                        <span class="text-sm font-medium text-ink"><?php echo esc_html( $category->name ); ?></span>
                    </a>
                </li>
            <?php 
                endforeach; 
    ...
    <section class="mx-auto max-w-6xl px-4 py-14">
        <div class="mb-8 flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <h2 class="text-2xl font-bold text-ink md:text-3xl">جدیدترین‌های رمانینو</h2>
            </div>
            <div class="flex gap-2">
                ...
                <button type="button" onclick="document.getElementById('newest-slider').scrollBy({left: 250, behavior: 'smooth'})" class="glass rounded-xl p-2.5 transition-shadow duration-100 hover:glow-gold" aria-label="قبلی">
                    <svg class="h-4 w-4 text-ink" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                </button>
                <button type="button" onclick="document.getElementById('newest-slider').scrollBy({left: -250, behavior: 'smooth'})" class="glass rounded-xl p-2.5 transition-shadow duration-100 hover:glow-gold" aria-label="بعدی">
                    <svg class="h-4 w-4 text-ink" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
                </button>
            </div>
        </div>
    ...
    <section class="mx-auto max-w-6xl px-4 py-14">
        <div class="mb-8 flex items-center justify-center gap-3">
            ...
            <h2 class="text-center text-2xl font-bold text-ink md:text-3xl">پرطرفدارترین‌ها در رمانینو، مرجع دانلود رمان شما</h2>
        </div>
        ...
        <div class="grid gap-6 lg:grid-cols-3">
            ...
            <div class="glass rounded-2xl p-5">
                <div class="mb-4 flex items-center gap-2">
                    <svg class="h-5 w-5 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z"></path></svg>
                    <h3 class="font-bold text-gold">رمان‌های پرفروش</h3>
                </div>
            ...
            <div class="glass rounded-2xl p-5">
                <div class="mb-4 flex items-center gap-2">
                    <svg class="h-5 w-5 text-cyan-glow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
                    <h3 class="font-bold text-cyan-glow">رمان‌های پربحث</h3>
                </div>
                <div class="max-h-[400px] overflow-y-auto pl-1">
                <ul class="flex flex-col gap-2.5">
                    <?php
            ...
            <div class="rounded-2xl border border-emerald-glow/40 bg-emerald-glow/5 p-5 backdrop-blur-md shadow-[0_0_20px_-5px_rgba(16,185,129,0.3)]">
                <div class="mb-4 flex items-center gap-2">
                    <svg class="h-5 w-5 text-emerald-glow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7"></path></svg>
                    <h3 class="font-bold text-emerald-glow">رمان‌های رایگان</h3>
                </div>
                <div class="max-h-[400px] overflow-y-auto pl-1">
                <ul class="flex flex-col gap-2.5">
                    <?php
    ...
    <section class="mx-auto max-w-6xl px-4 py-14">
        <div class="mb-8 flex items-center justify-center gap-3">
            ...
            <h2 class="text-center text-2xl font-bold text-ink md:text-3xl">دانلود رمان بر اساس ژانر</h2>
        </div>
    ...
    <section class="mx-auto max-w-6xl px-4 py-14">
        <div class="mb-8 flex items-center justify-center gap-3">
            <svg class="h-6 w-6 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
            <h2 class="text-center text-2xl font-bold text-ink md:text-3xl">نویسندگان برتر رمانینو، بهترین سایت خرید رمان</h2>
        </div>
            ...
            ?>
                <a href="<?php echo esc_url( $brand_link ); ?>" class="group flex shrink-0 snap-start flex-col items-center gap-3">
                    ...
                    <div class="rounded-full bg-gradient-to-br from-[#eab308] via-[#06b6d4] to-[#eab308] p-[3px] transition-shadow duration-150 group-hover:glow-gold">
                        <div class="relative flex h-24 w-24 items-center justify-center overflow-hidden rounded-full border-4 border-surface bg-surface-input md:h-28 md:w-28">
                            <?php if ( $brand_image ) : ?>
                            ...
                            <?php else : ?>
                                <svg class="h-10 w-10 text-ink-faint" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="text-center">
                        <p class="text-sm font-bold text-ink"><?php echo esc_html( $brand->name ); ?></p>
                        <p class="mt-0.5 text-xs text-ink-muted"><?php echo esc_html( $works_label ); ?></p>
                    </div>
                </a>
            <?php endforeach; ?>
        </div>
    ...
    <section class="mx-auto max-w-3xl px-4 py-14">
        <div class="mb-8 flex items-center justify-center gap-3">
            <svg class="h-6 w-6 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
            <h2 class="text-center text-2xl font-bold text-ink md:text-3xl">سوالات متداول درباره دانلود رمان از رمانینو</h2>
        </div>
            ...
            ?>
                <div class="glass overflow-hidden rounded-2xl">
                    ...
                    <div id="faq-ans-<?php echo $index; ?>" class="max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                        <p class="px-5 pb-5 text-sm leading-relaxed text-ink-muted"><?php echo esc_html($faq['a']); ?></p>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
