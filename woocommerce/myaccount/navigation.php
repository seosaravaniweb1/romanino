		...
		?>
			<li class="<?php echo esc_attr( $classes ); ?> shrink-0 lg:shrink">
				<a href="<?php echo esc_url( wc_get_account_endpoint_url( $endpoint ) ); ?>"
					class="flex items-center gap-2.5 whitespace-nowrap rounded-xl px-3.5 py-2.5 text-sm font-semibold transition-all duration-150 <?php echo $is_active ? 'glow-gold bg-primary text-primary-foreground' : 'text-ink-3 hover:bg-secondary hover:text-ink'; ?>">
